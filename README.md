...
## 在线预览
[移动端页面预览](http://music-app.strugglebak.com/)

[PC 端页面预览](http://music-admin.strugglebak.com/)
...
```
> 注意，在本项目中需要用到七牛云的密钥，所以要启动本项目的全部功能你需要去七牛云注册一个账号，并将你的 bucket 名字命名为 **music-1**，然后在**项目的根目录**创建 `qiniu-key.json`，形式是下面的样子
